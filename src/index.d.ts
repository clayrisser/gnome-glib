declare module 'gnome-glib' {
  ...
  export class HashTable {
    ...
    static foreach_remove(
      hash_table: HashTable,
      func: HRFunc,
      user_data: object | null
    ): number;
    static foreach_steal(
      hash_table: HashTable,
      func: HRFunc,
      user_data: object | null
    ): number;
    ...
    static new_full(
      hash_func: HashFunc,
      key_equal_func: EqualFunc,
      key_destroy_func: DestroyNotify | null,
      value_destroy_func: DestroyNotify | null
    ): HashTable;
  ...
  export class List {
    ...
    static insert_sorted_with_data(
      list: List,
      data: object | null,
      func: CompareDataFunc,
      user_data: object | null
  ...
  export class OptionGroup {
    ...
    set_parse_hooks(
      pre_parse_func: OptionParseFunc | null,
      post_parse_func: OptionParseFunc | null
    ): void;
    set_translate_func(
      func: TranslateFunc | null,
      data: object | null,
  ...
  export class PtrArray {
    ...
    static find_with_equal_func(
      haystack: object[],
      needle: object | null,
      equal_func: EqualFunc | null,
      index_?: number
    ): boolean;
    ...
    static new_full(
      reserved_size: number,
      element_free_func: DestroyNotify | null
    ): object[];
  ...
  export function ascii_strtoll(
    nptr: string,
    endptr: string,
    base: number
  ): number;
  export function ascii_strtoull(
    nptr: string,
    endptr: string,
    base: number
  ): number;
  ...
  export function assertion_message_cmpnum(
    domain: string,
    file: string,
    line: number,
    func: string,
  ...
  export function assertion_message_expr(
    domain: string | null,
    file: string,
    line: number,
    func: string,
  ...
  export function atomic_pointer_set(
    atomic: object,
    newval: object | null
  ): void;
  ...
  export function atomic_rc_box_dup(
    block_size: number,
    mem_block: object
  ): object;
  ...
  export function atomic_rc_box_release_full(
    mem_block: object,
  ...
  export function child_watch_add_full(
    priority: number,
    pid: Pid,
    _function: ChildWatchFunc,
    data: object | null,
  ...
  export function clear_handle_id(
    tag_ptr: number,
    clear_func: ClearHandleFunc
  ): void;
  ...
  export function convert_with_iconv(
    str: number[],
    len: number,
    converter: IConv,
    bytes_read: number,
  ...
  export function datalist_foreach(
    datalist: Data,
  ...
  export function datalist_id_dup_data(
    datalist: Data,
    key_id: Quark,
    dup_func: DuplicateFunc | null,
    user_data: object | null
  ): object | null;
  export function datalist_id_get_data(
    datalist: Data,
    key_id: Quark
  ): object | null;
  export function datalist_id_remove_no_notify(
    datalist: Data,
    key_id: Quark
  ): object | null;
  export function datalist_id_replace_data(
    datalist: Data,
    key_id: Quark,
    oldval: object | null,
    newval: object | null,
    destroy: DestroyNotify | null,
    old_destroy: DestroyNotify
  ): boolean;
  export function datalist_id_set_data_full(
    datalist: Data,
    key_id: Quark,
    data: object | null,
    destroy_func: DestroyNotify | null
  ): void;
  ...
  export function dataset_id_remove_no_notify(
    dataset_location: object,
    key_id: Quark
  ): object | null;
  export function dataset_id_set_data_full(
    dataset_location: object,
    key_id: Quark,
    data: object | null,
  ...
  export function format_size_full(
    size: number,
  ...
  export function io_add_watch_full(
    channel: IOChannel,
    priority: number,
    condition: IOCondition,
    func: IOFunc,
  ...
  export function log_default_handler(
    ...
    log_level: LogLevelFlags,
    message: string | null,
    unused_data: object | null
  ): void;
  export function log_remove_handler(
    log_domain: string,
    handler_id: number
  ): void;
  export function log_set_always_fatal(
    fatal_mask: LogLevelFlags
  ): LogLevelFlags;
  export function log_set_default_handler(
    log_func: LogFunc,
    user_data: object | null
  ): LogFunc;
  ...
  export function log_set_handler_full(
    log_domain: string | null,
    log_levels: LogLevelFlags,
    log_func: LogFunc,
    user_data: object | null,
  ...
  export function log_set_writer_func(
    func: LogWriterFunc | null,
    user_data: object | null,
  ...
  export function log_structured_standard(
    log_domain: string,
    log_level: LogLevelFlags,
    file: string,
    line: string,
  ...
  export function malloc0_n(
    n_blocks: number,
    n_block_bytes: number
  ): object | null;
  export function malloc_n(
    n_blocks: number,
    n_block_bytes: number
  ): object | null;
  export function markup_collect_attributes(
    element_name: string,
    attribute_names: string,
    attribute_values: string,
    error: Error,
    first_type: MarkupCollectType,
    first_attr: string,
    ...args: any[]
  ): boolean;
  ...
  export function pattern_match_simple(
    pattern: string,
    string: string
  ): boolean;
  export function pattern_match_string(
    pspec: PatternSpec,
    string: string
  ): boolean;
  export function pointer_bit_lock(address: object, lock_bit: number): void;
  export function pointer_bit_trylock(
    address: object,
    lock_bit: number
  ): boolean;
  ...
  export function propagate_prefixed_error(
    dest: Error,
    src: Error,
    format: string,
    ...args: any[]
  ): void;
  export function ptr_array_find(
    haystack: object[],
    needle: object | null,
    index_: number
  ): boolean;
  export function ptr_array_find_with_equal_func(
    haystack: object[],
    needle: object | null,
    equal_func: EqualFunc | null,
    index_: number
  ): boolean;
  export function qsort_with_data(
    pbase: object,
    total_elems: number,
    size: number,
    compare_func: CompareDataFunc,
  ...
  export function rc_box_release_full(
    mem_block: object,
    clear_func: DestroyNotify
  ): void;
  ...
  export function return_if_fail_warning(
    log_domain: string | null,
    pretty_function: string,
  ...
  export function slice_copy(
    block_size: number,
    mem_block: object | null
  ): object | null;
  export function slice_free1(
    block_size: number,
    mem_block: object | null
  ): void;
  export function slice_free_chain_with_offset(
    block_size: number,
    mem_chain: object | null,
    next_offset: number
  ): void;
  ...
  export function test_add_vtable(
    testpath: string,
    data_size: number,
    test_data: object | null,
    data_setup: TestFixtureFunc,
    data_test: TestFixtureFunc,
    data_teardown: TestFixtureFunc
  ): void;
  ...
  export function test_build_filename(
    file_type: TestFileType,
    first_path: string,
    ...args: any[]
  ): string;
  export function test_create_case(
    test_name: string,
    data_size: number,
    test_data: object | null,
    data_setup: TestFixtureFunc,
  ...
  export function test_get_filename(
    file_type: TestFileType,
    first_path: string,
    ...args: any[]
  ): string;
  ...
  export function test_log_set_fatal_handler(
    log_func: TestLogFatalFunc,
    user_data: object | null
  ): void;
  export function test_log_type_name(log_type: TestLogType): string;
  export function test_maximized_result(
    maximized_quantity: number,
    format: string,
    ...args: any[]
  ): void;
  export function test_message(format: string, ...args: any[]): void;
  export function test_minimized_result(
    minimized_quantity: number,
    format: string,
    ...args: any[]
  ): void;
  export function test_queue_destroy(
    destroy_func: DestroyNotify,
    destroy_data: object | null
  ): void;
  ...
  export function time_val_from_iso8601(
    iso_date: string,
    time_: TimeVal
  ): boolean;
  ...
  export function timeout_add_full(
    priority: number,
    interval: number,
    _function: SourceFunc,
    data: object | null,
  ...
  export function timeout_add_seconds_full(
    priority: number,
    interval: number,
    _function: SourceFunc,
    data: object | null,
  ...
  export function ucs4_to_utf16(
    str: number,
    len: number,
    items_read: number,
    items_written: number
  ): number;
  export function ucs4_to_utf8(
    str: number,
    len: number,
    items_read: number,
    items_written: number
  ...
  export function unix_fd_source_new(
    fd: number,
    condition: IOCondition
  ): Source;
  export function unix_open_pipe(fds: number, flags: number): boolean;
  export function unix_set_fd_nonblocking(
    fd: number,
    nonblock: boolean
  ): boolean;
  ...
  export function unix_signal_add_full(
    priority: number,
    signum: number,
    handler: SourceFunc,
    user_data: object | null,
  ...
  export function utf16_to_ucs4(
    str: number,
    len: number,
    items_read: number,
    items_written: number
  ): number;
  export function utf16_to_utf8(
    str: number,
    len: number,
    items_read: number,
    items_written: number
  ...
  export function utf8_collate_key_for_filename(
    str: string,
    len: number
  ): string;
  ...
  export function utf8_to_ucs4_fast(
    str: string,
    len: number,
    items_written: number
  ): number;
  ...
  export function utf8_validate(
    str: number[],
    max_len: number,
    end: string
  ): boolean;
  export function utf8_validate_len(
    str: number[],
    max_len: number,
    end: string
  ): boolean;
  ...
  export function warn_message(
    domain: string | null,
    file: string,
    line: number,
    func: string,
    warnexpr: string | null
  ): void;
  export type ChildWatchFunc = (
    pid: Pid,
    status: number,
    user_data: object | null
  ) => void;
  export type ClearHandleFunc = (handle_id: number) => void;
  export type CompareDataFunc = (
    a: object | null,
    b: object | null,
    user_data: object | null
  ) => number;
  ...
  export type DataForeachFunc = (
    key_id: Quark,
    data: object | null,
    user_data: object | null
  ) => void;
  export type DestroyNotify = (data: object | null) => void;
  export type DuplicateFunc = (
    data: object | null,
    user_data: object | null
  ) => object | null;
